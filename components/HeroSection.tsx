...
export default function HeroSection({ onOpenProjectModal }: HeroSectionProps) {
  ...
  return (
    <section id="hero" className="relative pt-32 pb-20 lg:pt-36 lg:pb-28 overflow-hidden bg-[#08090E] min-h-screen flex items-center">
      ...
      <div className="glow-orb-cyan -top-20 left-1/4 -translate-x-1/2 pointer-events-none opacity-80 animate-pulse" />
      <div className="glow-orb-violet top-40 right-10 pointer-events-none opacity-60" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto mb-8">
              <MagneticButton onClick={onOpenProjectModal}>
              ...
              <MagneticButton onClick={scrollToWork}>
                <div className="group inline-flex items-center justify-center gap-2 px-7 py-4 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-slate-200 hover:text-white font-medium text-sm tracking-wider transition-all duration-300 cursor-pointer">
